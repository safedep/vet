...
const file_checks_proto_rawDesc = "" +
	"\n" +
	"\fchecks.proto*\xd6\x01\n" +
	"\tCheckType\x12\x14\n" +
	"\x10CheckTypeUnknown\x10\x00\x12\x1a\n" +
	"\x16CheckTypeVulnerability\x10\x01\x12\x14\n" +
	"\x10CheckTypeMalware\x10\x02\x12\x17\n" +
	"\x13CheckTypePopularity\x10\x03\x12\x18\n" +
	"\x14CheckTypeMaintenance\x10\x04\x12\x1e\n" +
	"\x1aCheckTypeSecurityScorecard\x10\x05\x12\x14\n" +
	"\x10CheckTypeLicense\x10\x06\x12\x12\n" +
	"\x0eCheckTypeOther\x10d\"\x04\b\a\x10cB#Z!github.com/safedep/vet/gen/checksb\x06proto3"
