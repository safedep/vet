...
const (
	...
	MalwareType_EXCLUDED           MalwareType = 4
)
...
type MalwareInfo struct {
	...
	ExclusionReason string                 `protobuf:"bytes,3,opt,name=exclusion_reason,json=exclusionReason,proto3" json:"exclusion_reason,omitempty"`
	ThreatId        string                 `protobuf:"bytes,4,opt,name=threat_id,json=threatId,proto3" json:"threat_id,omitempty"`
	ExclusionId     string                 `protobuf:"bytes,5,opt,name=exclusion_id,json=exclusionId,proto3" json:"exclusion_id,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *MalwareInfo) GetExclusionReason() string {
	if x != nil {
...
func (x *MalwareInfo) GetExclusionId() string {
	if x != nil {
		return x.ExclusionId
	}
	return ""
}
...
const file_json_report_spec_proto_rawDesc = "" +
	...
	"\athreats\x18\a \x03(\v2\r.ReportThreatR\athreats\"\xce\x01\n" +
	"\vMalwareInfo\x12 \n" +
	"\x04type\x18\x01 \x01(\x0e2\f.MalwareTypeR\x04type\x122\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x0e2\x12.MalwareConfidenceR\n" +
	"confidence\x12)\n" +
	"\x10exclusion_reason\x18\x03 \x01(\tR\x0fexclusionReason\x12\x1b\n" +
	"\tthreat_id\x18\x04 \x01(\tR\bthreatId\x12!\n" +
	"\fexclusion_id\x18\x05 \x01(\tR\vexclusionId\"k\n" +
	"\n" +
	"ReportMeta\x12\x1b\n" +
