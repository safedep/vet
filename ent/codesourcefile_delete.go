...
func (_d *CodeSourceFileDelete) Where(ps ...predicate.CodeSourceFile) *CodeSourceFileDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *CodeSourceFileDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *CodeSourceFileDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *CodeSourceFileDelete) sqlExec(ctx context.Context) (int, error) {
...
type CodeSourceFileDeleteOne struct {
	_d *CodeSourceFileDelete
}

// Where appends a list predicates to the CodeSourceFileDelete builder.
func (_d *CodeSourceFileDeleteOne) Where(ps ...predicate.CodeSourceFile) *CodeSourceFileDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *CodeSourceFileDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *CodeSourceFileDeleteOne) ExecX(ctx context.Context) {
