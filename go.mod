...
require (
	buf.build/gen/go/safedep/api/grpc/go v1.5.1-20241023034507-f29b26e33b84.1
	buf.build/gen/go/safedep/api/protocolbuffers/go v1.35.1-20241023034507-f29b26e33b84.1
...
require (
	...
	github.com/anchore/go-macholibre v0.0.0-20241012210624-7602cd1e607f // indirect
