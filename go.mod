...
require (
	buf.build/gen/go/safedep/api/grpc/go v1.5.1-20241013112052-43f03a3d828a.1
	buf.build/gen/go/safedep/api/protocolbuffers/go v1.35.1-20241013112052-43f03a3d828a.1
