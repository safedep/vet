...
// CriticalBgText returns text with critical severity background (red)
func (c *ColorConfig) CriticalBgText(s string) string {
	if c.capability == CapabilityNone {
		return s
	}
	return text.BgHiRed.Sprint(s)
}
...
// HighBgText returns text with high severity background (red)
func (c *ColorConfig) HighBgText(s string) string {
	if c.capability == CapabilityNone {
		return s
	}
	return text.BgRed.Sprint(s)
}

// MediumBgText returns text with medium severity background (yellow)
func (c *ColorConfig) MediumBgText(s string) string {
	if c.capability == CapabilityNone {
		return s
	}
	return text.BgYellow.Sprint(s)
}

// LowBgText returns text with low severity background (blue)
func (c *ColorConfig) LowBgText(s string) string {
	if c.capability == CapabilityNone {
		return s
	}
	return text.BgBlue.Sprint(s)
}

// WarningText returns text with warning color (yellow)
...
// WarningBgText returns text with warning background (yellow)
...
// SuccessBgText returns text with success background (green)
func (c *ColorConfig) SuccessBgText(s string) string {
	if c.capability == CapabilityNone {
		return s
	}
	return text.BgGreen.Sprint(s)
}

// InfoBgText returns text with info background (blue)
...
// InfoText returns text with info foreground (blue)
...
func (c *ColorConfig) MagentaBgText(s string) string {
	...
	return text.BgMagenta.Sprint(s)
}
