...
func TestMarkdownBuildPlainText(t *testing.T) {
	markdownText := "# Heading 1\n## Heading 2\n### Heading 3\n#### Heading 4\n" +
		...
		"~~Strikethrough text~~ \n Line has `Inline code` between\n" +
		"Line has ``Inline code with backticks`` between \n ```Inline code in triple backticks```\n" +
